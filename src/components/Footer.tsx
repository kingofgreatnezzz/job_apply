        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#positions" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Available Positions
                </a>
              </li>
              <li>
                <a href="#application-form" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Apply Now
                </a>
              </li>
              <li>
                <a href="/only-admin" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Admin Panel
                </a>
              </li>
            </ul>
          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">teluscareer01@gmail.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-gray-300">+1 (347) 913-3410</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
